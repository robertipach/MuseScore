...
void Chord::setHamburgMusicNotation(bool flag)
      ...
      for (int i = 0; i < ns; ++i) {
            ...
            switch(n->pitch()) {
            case 36: { description = "1"; line = 16+8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 37: { description = "2"; line = 16+8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 38: { description = "3"; line = 15+8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 39: { description = "4"; line = 14+8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 40: { description = "5"; line = 14+8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 41: { description = "6"; line = 13+8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 42: { description = "7"; line = 12+8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 43: { description = "8"; line = 12+8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 44: { description = "9"; line = 11+8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 45: { description = "A"; line = 10+8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 46: { description = "B"; line = 10+8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 47: { description = "0"; line = 9+8; head = NoteHead::Group::HEAD_NORMAL; } break;
            ...
            case 84: { description = "1"; line = 0-8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 85: { description = "2"; line = 0-8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 86: { description = "3"; line = -1-8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 87: { description = "4"; line = -2-8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 88: { description = "5"; line = -2-8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 89: { description = "6"; line = -3-8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 90: { description = "7"; line = -4-8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 91: { description = "8"; line = -4-8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 92: { description = "9"; line = -5-8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 93: { description = "A"; line = -6-8; head = NoteHead::Group::HEAD_NORMAL; } break;
            case 94: { description = "B"; line = -6-8; head = NoteHead::Group::HEAD_CROSS; } break;
            case 95: { description = "0"; line = -7-8; head = NoteHead::Group::HEAD_NORMAL; } break;
            default: break;
            }
            if (line != n->line()) {
